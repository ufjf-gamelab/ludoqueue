...
export const initialState: GraphType = {
  nodes: [
    ...
    { id: "transport1", name: "Transport 1", type: "transport", val: 0 , max: 1, rate: 0.25, cooldown: 0.25},
    { id: "transport2", name: "Transport 2", type: "transport", val: 0 , max: 1, rate: 0.25, cooldown: 1},
